 ...
 */
final class Version20220404152517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collectionmed DROP FOREIGN KEY FK_DA13280FB4FE6DA3');
        $this->addSql('ALTER TABLE ressource DROP FOREIGN KEY FK_939F4544554C723');
        $this->addSql('DROP TABLE collectionmed');
        $this->addSql('DROP TABLE souscollectionmed');
        $this->addSql('DROP INDEX IDX_939F4544554C723 ON ressource');
        $this->addSql('ALTER TABLE ressource DROP souscollectionmed_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE collectionmed (id INT AUTO_INCREMENT NOT NULL, collectionmed_id INT NOT NULL, titre VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, presentation LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_DA13280FB4FE6DA3 (collectionmed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE souscollectionmed (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, presentation LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE collectionmed ADD CONSTRAINT FK_DA13280FB4FE6DA3 FOREIGN KEY (collectionmed_id) REFERENCES collectionmed (id)');
