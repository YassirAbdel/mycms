 ...
 */
final class Version20220312120528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE ressource_rubrique');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE ressource_rubrique (ressource_id INT NOT NULL, rubrique_id INT NOT NULL, INDEX IDX_C115B0A6FC6CD52A (ressource_id), INDEX IDX_C115B0A63BD38833 (rubrique_id), PRIMARY KEY(ressource_id, rubrique_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE ressource_rubrique ADD CONSTRAINT FK_C115B0A63BD38833 FOREIGN KEY (rubrique_id) REFERENCES rubrique (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ressource_rubrique ADD CONSTRAINT FK_C115B0A6FC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE texte CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE contenu contenu LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
