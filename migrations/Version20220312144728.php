 ...
 */
final class Version20220312144728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE texte_ressource (texte_id INT NOT NULL, ressource_id INT NOT NULL, INDEX IDX_883CFE5BEA6DF1F1 (texte_id), INDEX IDX_883CFE5BFC6CD52A (ressource_id), PRIMARY KEY(texte_id, ressource_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE texte_ressource ADD CONSTRAINT FK_883CFE5BEA6DF1F1 FOREIGN KEY (texte_id) REFERENCES texte (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE texte_ressource ADD CONSTRAINT FK_883CFE5BFC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE texte_ressource');
