 ...
 */
final class Version20220908112751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource ADD folder_front TINYINT(1) NOT NULL');
    }
