 ...
 */
final class Version20220315112119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE texte CHANGE titre titre VARCHAR(255) DEFAULT NULL, CHANGE contenu contenu LONGTEXT NOT NULL');
    }
