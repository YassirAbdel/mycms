 ...
 */
final class Version20220309160730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource CHANGE num_video num_video VARCHAR(255) DEFAULT NULL, CHANGE url_doc url_doc VARCHAR(255) DEFAULT NULL, CHANGE res_edit res_edit VARCHAR(255) DEFAULT NULL');
    }
