 ...
 */
final class Version20220404133257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE souscollection ADD collection_id INT NOT NULL');
        $this->addSql('ALTER TABLE souscollection ADD CONSTRAINT FK_AAD82F60514956FD FOREIGN KEY (collection_id) REFERENCES collection (id)');
        $this->addSql('CREATE INDEX IDX_AAD82F60514956FD ON souscollection (collection_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE collection CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE presentation presentation LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE souscollection DROP FOREIGN KEY FK_AAD82F60514956FD');
        $this->addSql('DROP INDEX IDX_AAD82F60514956FD ON souscollection');
        $this->addSql('ALTER TABLE souscollection DROP collection_id, CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE presentation presentation LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
