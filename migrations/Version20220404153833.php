 ...
 */
final class Version20220404153833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE souscollectioncnd ADD collectioncnd_id INT NOT NULL');
        $this->addSql('ALTER TABLE souscollectioncnd ADD CONSTRAINT FK_D6B2E602F9243DC2 FOREIGN KEY (collectioncnd_id) REFERENCES collectioncnd (id)');
        $this->addSql('CREATE INDEX IDX_D6B2E602F9243DC2 ON souscollectioncnd (collectioncnd_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE souscollectioncnd DROP FOREIGN KEY FK_D6B2E602F9243DC2');
        $this->addSql('DROP INDEX IDX_D6B2E602F9243DC2 ON souscollectioncnd');
        $this->addSql('ALTER TABLE souscollectioncnd DROP collectioncnd_id, CHANGE titre titre VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE presentation presentation LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
