 ...
 */
final class Version20220328152707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource ADD auteur_moral VARCHAR(255) DEFAULT NULL, ADD responsable_edition VARCHAR(255) DEFAULT NULL');
    }
