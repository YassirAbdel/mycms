 ...
 */
final class Version20220404154134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE souscollectioncnd_ressource (souscollectioncnd_id INT NOT NULL, ressource_id INT NOT NULL, INDEX IDX_CF1A2BA0488E9742 (souscollectioncnd_id), INDEX IDX_CF1A2BA0FC6CD52A (ressource_id), PRIMARY KEY(souscollectioncnd_id, ressource_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE souscollectioncnd_ressource ADD CONSTRAINT FK_CF1A2BA0488E9742 FOREIGN KEY (souscollectioncnd_id) REFERENCES souscollectioncnd (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE souscollectioncnd_ressource ADD CONSTRAINT FK_CF1A2BA0FC6CD52A FOREIGN KEY (ressource_id) REFERENCES ressource (id) ON DELETE CASCADE');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('DROP TABLE souscollectioncnd_ressource');
