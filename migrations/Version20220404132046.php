 ...
 */
final class Version20220404132046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE collection (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, presentation LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE souscollection (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, presentation LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE souscollection');
