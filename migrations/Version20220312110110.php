 ...
 */
final class Version20220312110110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE texte (id INT AUTO_INCREMENT NOT NULL, rubrique_id INT DEFAULT NULL, sousrubrique_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, contenu LONGTEXT DEFAULT NULL, INDEX IDX_EAE1A6EE3BD38833 (rubrique_id), INDEX IDX_EAE1A6EEBEE02DA1 (sousrubrique_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE texte ADD CONSTRAINT FK_EAE1A6EE3BD38833 FOREIGN KEY (rubrique_id) REFERENCES rubrique (id)');
        $this->addSql('ALTER TABLE texte ADD CONSTRAINT FK_EAE1A6EEBEE02DA1 FOREIGN KEY (sousrubrique_id) REFERENCES sousrubrique (id)');
    }
