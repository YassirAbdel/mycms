 ...
 */
final class Version20220312120841 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ressource_sousrubrique (ressource_id INT NOT NULL, sousrubrique_id INT NOT NULL, INDEX IDX_3739FF40FC6CD52A (ressource_id), INDEX IDX_3739FF40BEE02DA1 (sousrubrique_id), PRIMARY KEY(ressource_id, sousrubrique_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
