...
class SousrubriqueRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Sousrubrique $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Sousrubrique $entity, bool $flush = true): void
    {
    ...
    */
    public function findByIdrubrique($idrubrique)
    {
        return $this->createQueryBuilder('s')
            ->select('s', 'r')
            ->join('s.rubrique', 'r')
            ->andWhere('r.id = :idrubrique')
            ->setParameter('idrubrique', $idrubrique)
            ->getQuery()
            ->getResult()
        ;
    }
